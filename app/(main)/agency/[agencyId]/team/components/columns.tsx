...
export const colums: ColumnDef<UsersWithAgencySubAccountPermissionsSidebarOptions>[] =
  [
    {
      accessorKey: "id",
      header: "",
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return <CellAction rowData={rowData} />;
      },
    },
  ];
...
const CellAction: React.FC<CellActionProps> = ({ rowData }) => {
            ...
            onClick={() =>
              setOpen(
                <CustomModal
                  ...
                  subHeading="You can change permission only when the user has owned subaccount"
                >
                  <UserDetails
                    type="agency"
